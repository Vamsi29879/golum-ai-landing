        ...
        <section className="relative mx-auto max-w-6xl px-6 pb-16 pt-14 sm:pt-20">
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              >
                Next-Gen Ops/Retail{" "} <span className="italic text-gray-500">Seed &rarr; Sale</span> in Natural Language ▶︎ •၊၊||၊|။||||။‌‌‌‌‌၊|• 0:10 powered by{" "} <BrandMark className="whitespace-nowrap" />
              </motion.h1>
