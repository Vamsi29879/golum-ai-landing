          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              >
                ...
                interacted with by anybody regardless of their background. Our servers configured in custom context protocols connect to your systems to help sand-box/execute safe, evidence-grounded realities.
              </motion.p>
