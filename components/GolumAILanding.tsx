      ...
      <main className="relative">
        ...
        <section className="relative mx-auto max-w-6xl px-6 pb-16 pt-14 sm:pt-20">
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              >
                Next-Gen Ops/Retail{" "} <span className="italic text-gray-500">Seed &rarr; Sale</span> in &ldquo;Natural Language ▶︎ •၊၊||၊|။||||။‌‌‌‌‌၊|• 0:10 powered by{" "} <BrandMark className="whitespace-nowrap" />
              </motion.h1>
        ...
        <section id="products" className="relative mx-auto max-w-6xl px-6 py-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-pretty text-base leading-relaxed text-white/70 sm:text-lg">
              Simulate reality with Digital Twin, execute with a Digital Worker that lives in your workflow, Build a living operations system powered by an intel that evolves.
